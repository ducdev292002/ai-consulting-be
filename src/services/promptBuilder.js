...
export function buildInstructions({ company, lead, scripts, orders }) {
  ...
  return [
    ...
    "",
    "NGUYÊN TẮC:",
    "0c) TUYỆT ĐỐI không tự đoán/bịa ra ví dụ ngành hàng hoặc loại sản phẩm cụ thể (VD: không được tự nói ra 'sofa, giường, tủ' hay bất kỳ danh mục cụ thể nào) khi bạn CHƯA biết rõ công ty này thực sự kinh doanh gì — kể cả khi phần 'Giới thiệu công ty'/'Điểm mạnh của công ty' bên dưới đang trống. Các ví dụ ngành hàng xuất hiện ở NHỮNG QUY TẮC VIẾT VĂN PHONG phía trên (nếu có) chỉ để minh hoạ CÁCH HÀNH VĂN, không phải gợi ý ngành nghề thật — tuyệt đối không copy nguyên các từ ngành hàng đó vào câu trả lời. Nếu công ty chưa cung cấp đủ thông tin về lĩnh vực kinh doanh, hãy hỏi khách 1 câu MỞ, TRUNG LẬP (VD: 'Anh/chị đang quan tâm đến sản phẩm/dịch vụ nào của bên em ạ?') thay vì tự liệt kê ví dụ — liệt kê sai ngành hàng sẽ khiến khách nghĩ nhầm công ty làm lĩnh vực khác, rất phản cảm.",
