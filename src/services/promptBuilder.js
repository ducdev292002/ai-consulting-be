...
export function buildInstructions({ company, lead, scripts, orders }) {
  ...
  return [
    ...
    "3f) Trường stock trong kết quả searchProducts KHÔNG đáng tin để kết luận tình trạng hàng — rất nhiều sản phẩm trong hệ thống chưa được nhập số liệu tồn kho thật (stock=0 mặc định khi chưa cập nhật, GIỐNG như price=0 nghĩa là 'chưa có giá niêm yết' chứ không phải 'giá bằng 0'). Vì vậy quy tắc áp dụng CẢ HAI CHIỀU như nhau: TUYỆT ĐỐI KHÔNG được tự tuyên bố sản phẩm 'hết hàng'/'tạm hết hàng' CHỈ vì thấy stock=0, VÀ CŨNG TUYỆT ĐỐI KHÔNG được tự khẳng định 'còn hàng'/'đang có sẵn'/'luôn có hàng' nếu không có căn cứ đáng tin (đừng vì tránh nói 'hết hàng' mà lại lỡ khẳng định chắc chắn theo chiều ngược lại — cả hai đều là bịa nếu dữ liệu không đủ tin cậy). Khi khách hỏi về tình trạng hàng/số lượng cụ thể mà bạn không có căn cứ chắc chắn (VD tài liệu tri thức không nói rõ, hoặc chỉ dựa vào stock=0/trống): KHÔNG khẳng định còn hay hết theo bất kỳ chiều nào, chỉ nói kiểu 'để chắc chắn nhất về tồn kho/thời gian giao hàng, anh/chị để lại SĐT và khu vực để chuyên viên kiểm tra kho và xác nhận chính xác nhé' — biến việc không chắc chắn thành một lý do hợp lý để xin thông tin liên hệ, không phải một lời khẳng định liều lĩnh theo chiều nào. VD SAI cả hai kiểu: 'Sản phẩm này hết hàng rồi ạ' (khi chỉ dựa vào stock=0) và 'Sản phẩm này đang còn hàng ạ' (cũng chỉ dựa vào stock=0, không có nguồn nào khác xác nhận). Nếu hội thoại đang có dấu hiệu bất ổn (bạn đưa ra thông tin mâu thuẫn giữa các lượt, hoặc không chắc chắn về dữ liệu sản phẩm), đừng cố tự xử lý tiếp — thẳng thắn xin SĐT để chuyển cho nhân viên thật hỗ trợ kỹ hơn (theo tinh thần rule 11 bên dưới).",
